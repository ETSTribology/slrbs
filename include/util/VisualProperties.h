...
public:
    ...
    void addBodyProperties(
        ...
        // Debug visualization
        props.showContactPoints = showContactPoints;
        props.showInertiaEllipsoid = showInertiaEllipsoid;
        props.debugColorR = debugColorR;
        props.debugColorG = debugColorG;
        props.debugColorB = debugColorB;
